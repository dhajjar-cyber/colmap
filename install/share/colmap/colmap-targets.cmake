...
set_target_properties(colmap::colmap_controllers PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "COLMAP_LSD_ENABLED;GLOG_VERSION_MAJOR=0;GLOG_VERSION_MINOR=4;COLMAP_CGAL_ENABLED;COLMAP_CUDA_ENABLED;COLMAP_GPU_ENABLED"
...
set_target_properties(colmap::colmap_util PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "COLMAP_LSD_ENABLED;GLOG_VERSION_MAJOR=0;GLOG_VERSION_MINOR=4;COLMAP_CGAL_ENABLED;COLMAP_CUDA_ENABLED;COLMAP_GPU_ENABLED"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:\$<\$<AND:\$<CXX_COMPILER_ID:GNU>,\$<VERSION_LESS:\$<CXX_COMPILER_VERSION>,9.0>>:-lstdc++fs>>;Eigen3::Eigen;glog::glog;SQLite::SQLite3;Boost::boost"
)
